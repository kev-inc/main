...
public class EPiggyParserTest {
    ...
    //                FindExpenseCommand.COMMAND_ALIAS + " " + keywords.stream().collect(Collectors.joining(" ")));
    //        assertEquals(new FindExpenseCommand(new ExpenseContainsKeywordsPredicate(keywords), command);
    //    }
